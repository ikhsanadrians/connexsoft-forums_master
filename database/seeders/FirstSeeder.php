...
class FirstSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    Answer::create(["user_id" => 2, "content" => "1.Pake Shortcut Dari vscode, 2.pake intelissense , 3.banyakin baca dokumentasi slur", "question_id" => 1, "is_thebest" => 1]);
    Answer::create(["user_id" => 4, "content" => "Berdasarkan Pengalaman saya pake text editor neo-vim aja gan enak kok makenya aseli", "question_id" => 1, "is_thebest" => 1]);
